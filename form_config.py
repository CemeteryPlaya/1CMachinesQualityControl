...
def get_form_config(lang: str = "ru") -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {
            "id": "mileage",
            "label": get_translation(FIELD_LABELS, "mileage", lang),
            "type": "number",
            "required": True
        },
        {
        ...
        },
        {
            ...
            "type": "radio",
            "options": translate_options(["Нормальное", "Не нормальное", "Без ответа"], lang),
            "required": True
        },
        {
            "id": "paint_state",
        ...
        },
        {
            ...
            "type": "radio",
            "options": translate_options(["Отсутствует", "Имеется", "Без ответа"], lang),
            "required": True
        },
        {
            "id": "section_3_overall",
            "label": {"ru": "Кузов: Общее состояние", "en": "Body: Overall condition", "kk": "Кузов: Жалпы жағдайы", "uz": "Kuzov: Umumiy holat"}[lang],
            "type": "radio",
            "options": translate_options(["Нормальное", "Не нормальное", "Без ответа"], lang),
            "required": True
        },
        ...
        {
            "id": "section_5_overall",
            "label": {"ru": "Вспомогательное оборудование: Общее состояние", "en": "Auxiliary equipment: Overall condition", "kk": "Көмекші жабдық: Жалпы жағдайы", "uz": "Yordamchi uskunalar: Umumiy holat"}[lang],
            "type": "radio",
            "options": translate_options(["Нормальное", "Не нормальное", "Без ответа"], lang),
            "required": True
        },
        ...
        {
            "id": "section_6_overall",
            "label": {"ru": "Отсек двигателя: Общее состояние", "en": "Engine compartment: Overall condition", "kk": "Қозғалтқыш бөлімі: Жалпы жағдайы", "uz": "Dvigatel bo'limi: Umumiy holat"}[lang],
            "type": "radio",
            "options": translate_options(["Нормальное", "Не нормальное", "Без ответа"], lang),
            "required": True
        },
        ...
        {
            "id": "section_7_overall",
            "label": {"ru": "Ходовая часть: Общее состояние", "en": "Undercarriage: Overall condition", "kk": "Жүріс бөлігі: Жалпы жағдайы", "uz": "Harakat qismi: Umumiy holat"}[lang],
            "type": "radio",
            "options": translate_options(["Нормальное", "Не нормальное", "Без ответа"], lang),
            "required": True
        },
        ...
        },
        {
            ...
            "type": "radio",
            "options": translate_options(["Имеется", "Отсутствует", "Без ответа"], lang),
            "required": True
        },
        {
        ...
        {
            "id": "section_8_overall",
            "label": {"ru": "Оснащение и инструменты: Общее состояние", "en": "Equipment and tools: Overall condition", "kk": "Жабдықтау және құралдар: Жалпы жағдайы", "uz": "Jihozlar va asboblar: Umumiy holat"}[lang],
            "type": "radio",
            "options": translate_options(["Нормальное", "Не нормальное", "Без ответа"], lang),
            "required": True
        },

...
def get_form_config(lang: str = "ru") -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "required": True,
            "warning_text": {"ru": "Ваш текст предупреждения963", "en": "Your warning text", "kk": "...", "uz": "..."}[lang]
        },
        {
            "id": "paint_state",
        ...
        {
            "id": "differential_condition",
            "label": {"ru": "Состояние редуктора", "en": "Differential condition", "kk": "Редуктордың күйі", "uz": "Reduktorlarni holati"}[lang],
            "type": "radio",
            "options": translate_options(["Нормальное", "Не нормальное", "Другое"], lang),
            "required": True,
            "warning_text": {"ru": "Ваш текст предупреждения", "en": "Your warning text", "kk": "...", "uz": "..."}[lang]
        ...
        },
        {
            ...
            "label": {"ru": "Состояние колес и приводных валов", "en": "Wheels and driveshafts condition", "kk": "Доңғалақтар мен жетек біліктерінің жағдайы", "uz": "G'ildiraklar va qo'zg'aysan vallarining holati"}[lang],
            "type": "radio",
            "options": translate_options(["Нормальное", "Не нормальное", "Другое"], lang),
            "required": True,
            "warning_text": {"ru": "Ваш текст предупреждения", "en": "Your warning text", "kk": "...", "uz": "..."}[lang]
